      ...
      <React.Fragment>
        <div className='row Con'>
          <div className="col col-md-4 reportPart">
            ...
            <h1 className='formHero'>Jump right back in</h1>
            <h4 className='formText'>Sign in to continue</h4>
          </div>
          <div className="col col-md-8 formPart">
            <div className='formDetails'>
              <form onSubmit={this.handleFormSubmit}>
                <input type="email" name='email' placeholder='Email Address' className='loginInput' 
              ...
              <Link to="" className='forgotP'>Forgot password?</Link>
              <div className='accPart'>
                <p className='formPartUser'>New user?
                <Link to="/signup" className='forgotP'>Create account</Link></p>
